...
class AudioMapper(object):
    def __init__(self, d_cfg, final_config):
        ...
        self.melbins = final_config.model_cfg.audio_melbins
        self.target_length = final_config.model_cfg.audio_target_length
        self.training = d_cfg.training
        self.frame_shift = 10
        self.sample_num = d_cfg.audio_sample_num
        self.audio_encoder_type = final_config.model_cfg.audio_encoder_type
